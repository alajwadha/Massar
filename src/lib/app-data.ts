...
export const ui = {
  ...
  study: {
    ...
    timelineBrief: { ar: ['ابدأ قبل سنة تقريبًا', 'مواعيد أمريكا غالبًا في ديسمبر', 'بريطانيا تتفاوت وغالبًا على دفعات', 'أنجز اختبارات اللغة وGMAT مبكرًا'], en: ['Start about a year ahead', 'US deadlines are mostly December', 'UK varies, often rolling', 'Sit language and GMAT tests early'] },
    fundingBrief: { ar: ['منحة حكومية (بعثتك)', 'منحة رواد عند قبول من أفضل 30 جامعة', 'ابتعاث جهة العمل أو مساعدات بحثية بالخارج'], en: ['Government scholarship (بعثتك)', 'Pioneers scholarship for a top-30 offer', 'Employer study leave, or assistantships abroad'] },
