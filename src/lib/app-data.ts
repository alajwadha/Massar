...
const alhajjiStudyMajors: StudyMajor[] = [
  {
    ...
    programs: [
      ...
      { tier: 'respected', top30: true, uni: { ar: 'معهد كايست، كوريا', en: 'KAIST' }, program: { ar: 'ماجستير الهندسة الميكانيكية', en: 'MSc Mechanical Engineering' }, location: { ar: 'دايجون، كوريا الجنوبية', en: 'Daejeon, South Korea' }, link: 'https://me.kaist.ac.kr/eng/education/education_020200.html' },
      ...
      { tier: 'accessible', uni: { ar: 'جامعة قطر', en: 'Qatar University' }, program: { ar: 'ماجستير الهندسة الميكانيكية', en: 'MSc Mechanical Engineering' }, location: { ar: 'الدوحة، قطر', en: 'Doha, Qatar' }, link: 'https://www.qu.edu.qa/engineering/graduate/master-mechanical' },
    ],
  },
  {
    ...
    programs: [
      ...
      { tier: 'solid', uni: { ar: 'جامعة خليفة', en: 'Khalifa University' }, program: { ar: 'ماجستير هندسة البترول', en: 'MSc Petroleum Engineering' }, location: { ar: 'أبوظبي، الإمارات', en: 'Abu Dhabi, UAE' }, link: 'https://www.ku.ac.ae/academics/graduate-programs/m-sc-in-petroleum-engineering' },
      { tier: 'accessible', uni: { ar: 'جامعة تكنولوجي بتروناس', en: 'Universiti Teknologi PETRONAS' }, program: { ar: 'ماجستير هندسة البترول', en: 'MSc Petroleum Engineering' }, location: { ar: 'بيراق، ماليزيا', en: 'Perak, Malaysia' }, link: 'https://www.utp.edu.my/Pages/Admission/Postgraduate/Master-by-Coursework/MSc-in-Petroleum-Engineering.aspx' },
    ],
  },
  {
    ...
    programs: [
      { tier: 'high', top30: true, uni: { ar: 'جامعة آخن التقنية', en: 'RWTH Aachen University' }, program: { ar: 'ماجستير هندسة المواد', en: 'MSc Materials Engineering' }, location: { ar: 'آخن، ألمانيا', en: 'Aachen, Germany' }, link: 'https://www.rwth-aachen.de/cms/root/studium/vor-dem-studium/studiengaenge/liste-aktuelle-studiengaenge/studiengangbeschreibung/~omse/materials-engineering-m-sc/' },
      { tier: 'respected', top30: true, uni: { ar: 'جامعة سنغافورة الوطنية', en: 'National University of Singapore' }, program: { ar: 'ماجستير علوم وهندسة المواد', en: 'MSc Materials Science and Engineering' }, location: { ar: 'سنغافورة', en: 'Singapore' }, link: 'https://cde.nus.edu.sg/mse/graduates/master-of-science-msc/' },
      { tier: 'solid', uni: { ar: 'جامعة مانشستر', en: 'University of Manchester' }, program: { ar: 'ماجستير هندسة المواد (التآكل والبيئات القاسية)', en: 'MSc Materials Engineering (Corrosion, Demanding Environments)' }, location: { ar: 'مانشستر، المملكة المتحدة', en: 'Manchester, United Kingdom' }, link: 'https://www.manchester.ac.uk/study/masters/courses/list/21734/msc-materials-engineering-for-sustainability-in-demanding-environments' },
      { tier: 'accessible', uni: { ar: 'جامعة الملك فهد للبترول والمعادن', en: 'KFUPM' }, program: { ar: 'ماجستير علوم وهندسة المواد', en: 'MSc Materials Science and Engineering' }, location: { ar: 'الظهران، السعودية', en: 'Dhahran, Saudi Arabia' }, link: 'https://bulletin.kfupm.edu.sa/main/program?program_id=159&title=master-of-science-in-materials-science-and-engineering' },
    ],
  },
];
