...
export const ui = {
  ...
  network: {
    ...
    body: {
      ar: 'ارفع ملف جهات اتصالك (Connections.csv) ونرتّب لك شبكتك ونطلّع أقرب الناس لأهدافك تتواصل معهم أول. المقدمة الدافئة أفضل من الرسالة الباردة. نحفظ ملفك بأمان في ملفّك الشخصي عشان نطابق شبكتك، ما نشاركه مع أحد، وتقدر تطلب حذفه في أي وقت.',
