...
const alhajjiStudyMajors: StudyMajor[] = [
  {
    ...
    programs: [
      { tier: 'high', top30: true, uni: { ar: 'جامعة نيو ساوث ويلز', en: 'UNSW Sydney' }, program: { ar: 'ماجستير الهندسة الميكانيكية', en: 'Master of Engineering (Mechanical)' }, location: { ar: 'سيدني، أستراليا', en: 'Sydney, Australia' }, link: 'https://www.unsw.edu.au/study/postgraduate/master-of-engineering-mechanical-engineering' },
      { tier: 'respected', top30: true, uni: { ar: 'جامعة مانشستر', en: 'University of Manchester' }, program: { ar: 'ماجستير تصميم الهندسة الميكانيكية', en: 'MSc Mechanical Engineering Design' }, location: { ar: 'مانشستر، المملكة المتحدة', en: 'Manchester, United Kingdom' }, link: 'https://www.manchester.ac.uk/study/masters/courses/list/04342/msc-mechanical-engineering-design/' },
      { tier: 'solid', uni: { ar: 'جامعة ولاية بنسلفانيا', en: 'Pennsylvania State University' }, program: { ar: 'ماجستير الهندسة الميكانيكية', en: 'MS Mechanical Engineering' }, location: { ar: 'بنسلفانيا، الولايات المتحدة', en: 'Pennsylvania, USA' }, link: 'https://www.me.psu.edu/students/graduate/Mechanical-MSDegree.aspx' },
      { tier: 'accessible', uni: { ar: 'جامعة شيفيلد', en: 'University of Sheffield' }, program: { ar: 'ماجستير الهندسة الميكانيكية المتقدمة', en: 'MSc Advanced Mechanical Engineering' }, location: { ar: 'شيفيلد، المملكة المتحدة', en: 'Sheffield, United Kingdom' }, link: 'https://www.sheffield.ac.uk/postgraduate/taught/courses/2026/advanced-mechanical-engineering-msc' },
    ],
  },
  {
    ...
    programs: [
      { tier: 'high', top30: true, uni: { ar: 'جامعة تكساس في أوستن', en: 'University of Texas at Austin' }, program: { ar: 'ماجستير هندسة البترول والأنظمة الجيولوجية', en: 'MS Petroleum and Geosystems Engineering' }, location: { ar: 'أوستن، تكساس، الولايات المتحدة', en: 'Austin, Texas, USA' }, link: 'https://www.pge.utexas.edu/graduate/' },
      ...
      { tier: 'solid', uni: { ar: 'جامعة أديلايد', en: 'University of Adelaide' }, program: { ar: 'ماجستير هندسة البترول', en: 'Master of Petroleum Engineering' }, location: { ar: 'أديلايد، أستراليا', en: 'Adelaide, Australia' }, link: 'https://www.adelaide.edu.au/degree-finder/mpen_mpetroleng.html' },
  ...
  },
  {
    ...
    programs: [
      { tier: 'high', top30: true, uni: { ar: 'جامعة مانشستر', en: 'University of Manchester' }, program: { ar: 'ماجستير هندسة المواد (التآكل والبيئات القاسية)', en: 'MSc Materials Eng (Corrosion, Demanding Environments)' }, location: { ar: 'مانشستر، المملكة المتحدة', en: 'Manchester, United Kingdom' }, link: 'https://www.manchester.ac.uk/study/masters/courses/list/21734/msc-materials-engineering-for-sustainability-in-demanding-environments/' },
      { tier: 'respected', uni: { ar: 'معهد فرجينيا للتقنية', en: 'Virginia Tech' }, program: { ar: 'ماجستير علوم وهندسة المواد', en: 'MS Materials Science and Engineering' }, location: { ar: 'فرجينيا، الولايات المتحدة', en: 'Virginia, USA' }, link: 'https://mse.vt.edu/Programs/graduate-program.html' },
      { tier: 'solid', top30: true, uni: { ar: 'جامعة موناش', en: 'Monash University' }, program: { ar: 'ماجستير الهندسة (هندسة المواد)', en: 'Master of Engineering (Materials)' }, location: { ar: 'ملبورن، أستراليا', en: 'Melbourne, Australia' }, link: 'https://www.monash.edu/engineering/master-engineering/specialisations/materials-engineering' },
      { tier: 'accessible', uni: { ar: 'جامعة ميشيغان للتقنية', en: 'Michigan Technological University' }, program: { ar: 'ماجستير علوم وهندسة المواد', en: 'MS Materials Science and Engineering' }, location: { ar: 'ميشيغان، الولايات المتحدة', en: 'Michigan, USA' }, link: 'https://www.mtu.edu/materials/graduate/program/' },
    ],
  },
];
