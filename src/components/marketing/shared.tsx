...
import { CARD, EDGE, INSET, PILL, GHOST, SOFT, ACCENT, NOISE, pick } from '@/lib/marketing-data';
...
/* TARGET_COMPANIES, PRICING, STATS and pick() are defined in
   '@/lib/marketing-data' and re-exported near the top of this file. */
